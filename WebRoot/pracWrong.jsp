...
<html lang="zxx">
    ...
    <body>
        ...
        <div class="container">
            <ul class="breadcrumb">
                <li><a href="index.html"><i class="fa fa-home m-r-5"></i>主页</a></li>
                <li>练习错题</li>
            </ul>
        </div>
        <!-- 练习错题 -->
                                ...
                                <tr>
                                   <td align="left">
                                    ...
                                    <td align="right">
                                     ...
                                     <td>
                                        <input type="text" name="answer+<%=i %>+" class="search-txt form-item"/>
                                     </td>
                                 </tr>  
                                 <%
                                 }   
                                 ...
                                 <tr>
                                     <td>
                                         <button type="submit" class="btn ht-btn bg-3 m-t-10">交卷</button>
                                     </td>
                                     <td>
